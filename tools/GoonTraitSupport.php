...
trait GoonTraitSupport
{
    ...
    public function addemail(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $arrParams['itens'] = array(array("codloja" => Config::get('app.sequence_codloja'), "email" => $email, "nome" => $nome));
     ...
     * @return \Illuminate\Http\Response
     */
    public function getImgLink($id, $tm, $mon = 'n', $dm = 0, $nm = "")
    {
        return $this->getimg($id, $tm, $nm, $mon, $dm);
    }
